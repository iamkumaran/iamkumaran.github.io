...
console.log(physics.element.height)
		// Create some walls
		walls.left = new Body(physics, { color: "red", type: "static", x: 0, y: 0, height: physics.element.height,  width: 0.5 });
		//walls.right = new Body(physics, { color: "red", type: "static", x:51, y: 0, height: 50,  width: 0.5});
		walls.top = new Body(physics, { color: "red", type: "static", x: 0, y: 0, height: 0.5, width: physics.element.width });
		walls.bottom = new Body(physics, { color: "red", type: "static", x: 0, y:inner_height, height: 0.5, width: physics.element.width });
		...
		physics.dragNDrop();
		player = new Body(physics, {shape: 'circle', image:img_bkg, x: 15, y: 12, width: 2, height:2, radius:1 }).body;
	...
	function setPillars(physics){
		...
		for (var i = 2; i < 3000; i++){
			...
			beams.push(new Body(physics, { image: img, type: "static", x: x, y: y, height: ht,  width: wt }));
		}
	}
	...
	function init() {
		...
		img.addEventListener("load", function() {
			...
			img_bkg.src = 'images/smily-40.png';
		});
